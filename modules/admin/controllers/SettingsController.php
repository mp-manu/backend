...
class SettingsController extends Controller
{
     ...
     */
    public $indexView = '@app/modules/admin/views/settings/index';

    /**
     * @var string path to create view file, which is used in admin panel
     */
    public $createView = '@app/modules/admin/views/settings/create';

    /**
     * @var string path to update view file, which is used in admin panel
     */
    public $updateView = '@app/modules/admin/views/settings/update';

    /**
     * @var string search class name for searching
     */
    public $searchClass = 'app\modules\admin\models\search\SettingSearch';
