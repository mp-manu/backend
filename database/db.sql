...
insert  into `service_info`(`id`,`service_id`,`key`,`val`,`description`,`status`) values 
(1,1,'advantage','Преимущества способа','Штамповка - самый недорогой способ получить множество деталей на 100% соответсвующих чертежу.\r\nДолговечность изделий.\r\nВысокая скорость, большие объемы.',1),
(2,1,'when_you_need','Когда вам нужна штамповка','Нужно быстро сделать много деталей по чертежам.\r\nУ вас есть чертежи.\r\nТолщина детали в широкой части не более 5 мм.\r\nВам нужны детали сложных форм с высокой точностью размеров.',1),
(3,1,'our_equipment','Наше оборудование','Пресса кривошипные с усилием от 6 до 100 тонн.\r\nПресс ножницы комбинированные.\r\nНожницы гильотинные до 12 мм.',1);
