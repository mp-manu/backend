...
(6,1,'Мой вопрос',NULL,'Манучехр','+7 (992) 929 92 92',2,1);
...
(27,0,'Пользователи','Пользователи','#','ALL',1,1,4,NULL,NULL,'person','no','no','<span class=\"label label-rouded label-menu label-danger\">4</span>','yes','arrow','left'),
