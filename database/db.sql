...
(8,9,'adwad','awdadawdadwa','dwadada','',1,1);
...
(1,'Ману','+7 (959) 595 95 23',NULL,NULL,1,'2019-10-17 11:25:58');
...
(110,9,'awdwad',2.00,33,'76-90','awdawdwa',23131232.00,2,1),
(111,9,'awdwad',2.00,100,'76-90','dawdawda',450000.00,2,1);
...
(11,7,'фцвфцвфвцфвцф','Преимущества способа',NULL,'фвфц вфцвфвцфвф',1),
(12,8,'adwwad','Преимущества способа',NULL,'',1),
(13,9,'asdsadsada','Преимущества способа',NULL,'',1),
(14,10,'awdad','dawdwa',NULL,'awdwadwa',1),
(15,9,'when_you_need','Преимущества способа',NULL,'awdwadwa',1);
...
(3,2,'Гибка металлопрофиля','gibka-metalloprofilya','Это самый распространённый способ изготовления карнизов, рельс для дверей, оконных откосов, металлических уголков для декорирования помещений, скоб, самых сложных металлических коробов для компьютерной и другой техники и многие другие.','service_cover_3.jpg',NULL,1),
(4,2,'Гибка труб','gibka-trub','С самого начала выверяем всё с максимальной точностью. Чем точнее первый этап, тем меньше в дальнейшем будет трудностей. Оснастку мы изготавливаем сперва на станке, а затем доводим вручную, пока она не будет на 100% соответствовать чертежу. Мы не начинаем штамповку, пока она не достигнет максимально точных размеров. Иначе у нас не бывает.','service_cover_4.jpg',NULL,1),
(5,2,'Гибка листового метала','gibka-listovogo-metala','С самого начала выверяем всё с максимальной точностью. Чем точнее первый этап, тем меньше в дальнейшем будет трудностей. Оснастку мы изготавливаем сперва на станке, а затем доводим вручную, пока она не будет на 100% соответствовать чертежу. Мы не начинаем штамповку, пока она не достигнет максимально точных размеров. Иначе у нас не бывает.','service_cover_5.jpg',NULL,1),
(6,2,'Гибка стальных листов','gibka-stalnyh-listov','С самого начала выверяем всё с максимальной точностью. Чем точнее первый этап, тем меньше в дальнейшем будет трудностей. Оснастку мы изготавливаем сперва на станке, а затем доводим вручную, пока она не будет на 100% соответствовать чертежу. Мы не начинаем штамповку, пока она не достигнет максимально точных размеров. Иначе у нас не бывает.','service_cover_6.jpg',NULL,1),
(7,0,'Новая услуга','dfoyv-fvofldcovcf','фывфцвцфвфцвкцфвцфвфвцфвцф','service_cover_7.jpg',NULL,1),
(8,0,'adawdad','awdwadwa','awdwadwa','service_cover_8.jpg',NULL,1),
(9,0,'asdsadasdada','asdada','dadsadadasdada','service_cover_9.jpg',NULL,1),
(10,0,'asdawdwa','asdwadaw','dawdwadawdadaw','service_cover_10.jpg',NULL,1);
...
(1,'Серийно производим <br> детали по чертежам с погрешностью 0.001 мм','И постоянно совершенствуемся','slide-cover_1.jpg','slide-cover-img-1.png',1,'Заказать по чертежу','',0,1),
(2,'Производим методом холодной штамповки более 2000 видов деталей','разрабатываем уникальные формы на заказ для серийной штамповки.','slide-cover_2.jpg','slide-cover-img-2.png',1,'Заказать по чертежу','',0,1);
...
(4,9,'awdawda','dawdawdwaada','work-proccess_3.jpg',1),
(5,9,'awdawda','','work-proccess_5.jpg',1);
...
(5,9,'awdawdwa','Форма петель не типовая,дизайнерская. Поэтому основные трудозатраты - создание форм и оснастка. А дальше дело техники','за 560 часов','700 000 руб','10 тонн','work-result_4.jpg',1),
(7,9,'awdwad','Форма петель не типовая,дизайнерская. Поэтому основные трудозатраты - создание форм и оснастка. А дальше дело техники','343','234242','10 тонн','work-result_6.jpg',1);
