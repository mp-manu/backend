...
(40,2,'Метатеги и ЯндексМетрика','Метатеги и ЯндексМетрика','/admin/web-master/meta-tags-and-yametrika-scripts','ALL',1,1,10,NULL,NULL,NULL,'no','no','','yes',NULL,'left'),
(41,2,'Указать адрес на карте','Указать адрес на карте','/admin/web-master/contact-map','ALL',1,1,10,NULL,NULL,NULL,'no','no','','yes',NULL,'left');
...
CREATE TABLE `company_map` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `center1` varchar(30) DEFAULT NULL,
  `center2` varchar(30) DEFAULT NULL,
  `coord1` varchar(30) DEFAULT NULL,
  `coord2` varchar(30) DEFAULT NULL,
...
DROP TABLE IF EXISTS `metatags_yandex_metrika`;

CREATE TABLE `metatags_yandex_metrika` (
...
/*Data for the table `metatags_yandex_metrika` */

insert  into `metatags_yandex_metrika`(`id`,`tags`,`scripts`,`description`,`type`,`status`) values 
(1,'<meta name=\"yandex-verification\" content=\"a05fb2b7f3bc0d53\" />','<!-- Yandex.Metrika counter -->\r\n<script type=\"text/javascript\" >\r\n   (function(m,e,t,r,i,k,a){m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)};\r\n   m[i].l=1*new Date();k=e.createElement(t),a=e.getElementsByTagName(t)[0],k.async=1,k.src=r,a.parentNode.insertBefore(k,a)})\r\n   (window, document, \"script\", \"https://mc.yandex.ru/metrika/tag.js\", \"ym\");\r\n\r\n   ym(55893892, \"init\", {\r\n        clickmap:true,\r\n        trackLinks:true,\r\n        accurateTrackBounce:true\r\n   });\r\n</script>\r\n<noscript><div><img src=\"https://mc.yandex.ru/watch/55893892\" style=\"position:absolute; left:-9999px;\" alt=\"\" /></div></noscript>\r\n<!-- /Yandex.Metrika counter -->','',1,1);
...
(4,2,'Гибка металлопрофиля','gibka-metalloprofilya','Это самый распространённый способ изготовления карнизов, рельс для дверей, оконных откосов, металлических уголков для декорирования помещений, скоб, самых сложных металлических коробов для компьютерной и другой техники и др.','service_cover_4.jpg',NULL,1),
...
(41,'string','Услуги','услуги_компании_техарсенал','Услуги компании ТехАрсенал',1,'Услуги компании ТехАрсенал',1571806949,1571806949),
(42,'string','Услуги','описание','Производим методом холодной штамповки более 2000 видов стандартных деталей, разрабатываем уникальные формы на заказ для серийной штамповки.',1,'Производим методом холодной штамповки более 2000 видов стандартных деталей, разрабатываем уникальные формы на заказ для серийной штамповки.',1571806981,1571806981);
...
(1,'Серийно производим детали по чертежам с погрешностью 0.001 мм','И постоянно совершенствуемся','slide-cover_1.jpg','slide-cover-img-1.png',1,'Заказать по чертежу','',0,1),
(2,'Производим методом холодной штамповки более 2000 видов деталей','и разрабатываем уникальные формы на заказ для серийной штамповки.','slide-cover_2.jpg','',1,'Заказать по чертежу','',2,1);
